...
--> 2 : We can use parenthesis or we can't no issue but better to use parenthesis in union
...
--> 3 : https://github.com/anand-kumar96/SQL/assets/106487247/e762b843-ab46-4d5b-8916-49d4172cd495
...
--> 4 : Removing Commonalities With Except
...
--> 5 : Practice : https://github.com/anand-kumar96/SQL/assets/106487247/8ee0d4e6-db43-4cb4-90c2-33b6c65c849e
--> 6 : Solution : 
        SELECT manufacturer 
        FROM phones
        WHERE price < 170
