--> 2 : https://github.com/anand-kumar96/SQL/assets/106487247/b5c84d2a-b5df-47be-9dee-c71245c41977  
...
--> 3 : Question : https://github.com/anand-kumar96/SQL/assets/106487247/27e8b7a3-77b1-489e-893d-6d9d49e56b60
    --> Answer
...
--> 4 : Question : https://github.com/anand-kumar96/SQL/assets/106487247/8cecd500-b608-4fa8-800f-fd5b39570141
    --> Answer
    Select contents, url 
    FROM comments
...
--> 5 Practice Question : https://github.com/anand-kumar96/SQL/assets/106487247/6a445701-22d0-4d22-b493-bc659160e9fd
...
--> 6 / 7 : https://github.com/anand-kumar96/SQL/assets/106487247/3fb4da63-0b3a-4579-b7ad-96fb96ee578f
  ...
  --> 02 : Combing two tables which contain same column name and retriving it may throw error so better to give some name
   ...
   --> 03 Alias Uses to rename table --> best way to write
       ...
       JOIN comments As c
       On p.id = c.photo_id;
--> 8 : https://github.com/anand-kumar96/SQL/assets/106487247/76943313-a5e2-400c-b6a9-0fe586018b23
...
--> 9 : Ques: Why extra photo that added will null user_id not get added into our join result set ? 
  --> : Ans:
           Select p.url, u.username 
           FROM photos As p
           JOIN users As u
