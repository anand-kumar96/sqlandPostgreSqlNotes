...
--> 03: Group By Review Practice
    --> Question: Write a query to print number of paid and unpaid orders.
...
--> 05: Inner Join Reviews Practice
    --> Question: Join together users and tables. print the first_name and last_name of each user then weather or not thy have paid for their orders.

--> 06: Solution
        SELECT u.first_name,u.last_name,paid 
        FROM orders AS o
