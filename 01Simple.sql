...
SELECT area,name,name,name,country FROM cities;

---- Calutating Density 
SELECT name, population / area As population_density 
FROM cities;

------------------ STRING Operator And Function -------------------------------
SELECT name || country FROM cities;
SELECT name || ', ' || country FROM cities;
...
---OR
SELECT UPPER(CONCAT(name, ', ', country)) AS location FROM
