...
--> 03: The 'OFFSET' syntax in SQL is a clause used to skip a certain number of rows when returning the result set of a query. 
...
--> 04: Sorting, Offsetting and Limiting Question
